    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-campaigns">GET api/campaigns</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-campaigns">
                                <a href="#endpoints-POSTapi-campaigns">POST api/campaigns</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-campaigns--id-">
                                <a href="#endpoints-GETapi-campaigns--id-">GET api/campaigns/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-campaigns--id-">
                                <a href="#endpoints-PUTapi-campaigns--id-">PUT api/campaigns/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-campaigns--id-">
                                <a href="#endpoints-DELETEapi-campaigns--id-">DELETE api/campaigns/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-posts">GET api/posts</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-posts--generatedPost_id-">
                                <a href="#endpoints-GETapi-posts--generatedPost_id-">GET api/posts/{generatedPost_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-posts--generatedPost_id--status">
                                <a href="#endpoints-PATCHapi-posts--generatedPost_id--status">PATCH api/posts/{generatedPost_id}/status</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-posts--post_id--chat">
                                <a href="#endpoints-POSTapi-posts--post_id--chat">POST api/posts/{post_id}/chat</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-conversations">
                                <a href="#endpoints-GETapi-conversations">GET api/conversations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-conversations--conversation_id-">
                                <a href="#endpoints-GETapi-conversations--conversation_id-">GET api/conversations/{conversation_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-conversations--conversation_id-">
                                <a href="#endpoints-PATCHapi-conversations--conversation_id-">PATCH api/conversations/{conversation_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-conversations--conversation_id-">
                                <a href="#endpoints-DELETEapi-conversations--conversation_id-">DELETE api/conversations/{conversation_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-campaigns">GET api/campaigns</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-campaigns">POST api/campaigns</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="target_audience"                data-endpoint="POSTapi-campaigns"
               value="n"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="tone"                data-endpoint="POSTapi-campaigns"
               value="g"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="max_characters"                data-endpoint="POSTapi-campaigns"
               value="16"
               data-component="body">
    <br>
<p>Must be at least 50. Must not be greater than 1000. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_hashtags"                data-endpoint="POSTapi-campaigns"
               value="7"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="style_rules"                data-endpoint="POSTapi-campaigns"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-campaigns--id-">GET api/campaigns/{id}</h2>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/campaigns/1"
);
...
<p>The ID of the campaign. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-campaigns--id-">PUT api/campaigns/{id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="target_audience"                data-endpoint="PUTapi-campaigns--id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="tone"                data-endpoint="PUTapi-campaigns--id-"
               value="g"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>g</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_characters"                data-endpoint="PUTapi-campaigns--id-"
               value="16"
               data-component="body">
    <br>
<p>Must be at least 50. Must not be greater than 1000. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_hashtags"                data-endpoint="PUTapi-campaigns--id-"
               value="7"
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 10. Example: <code>7</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="style_rules"                data-endpoint="PUTapi-campaigns--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-campaigns--id-">DELETE api/campaigns/{id}</h2>
...
<div class="bash-example">
    ...
    --data "{
    \"campaign_id\": 16,
    \"content\": \"ngzmiyvdljnikhwaykcmyuwpwlvqwrsitcpscqldzsnrwtujwvlxjklqppwqbewtnnoqitpxntlt\",
    \"source_type\": \"c\"
}"
</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="campaign_id"                data-endpoint="POSTapi-content-repurpose"
               value="16"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 20 characters. Example: <code>ngzmiyvdljnikhwaykcmyuwpwlvqwrsitcpscqldzsnrwtujwvlxjklqppwqbewtnnoqitpxntlt</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="source_type"                data-endpoint="POSTapi-content-repurpose"
               value="c"
               data-component="body">
    <br>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-posts--generatedPost_id-">GET api/posts/{generatedPost_id}</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the generatedPost. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PATCHapi-posts--generatedPost_id--status">PATCH api/posts/{generatedPost_id}/status</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-posts--post_id--chat">POST api/posts/{post_id}/chat</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"message\": \"bngzmiyvdljnikhwaykcmyuwpwlvqwrsitcpscqldzsnrwtujwvlxjklqppwqbewtnnoqitpxn\",
    \"conversation_id\": 16
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="conversation_id"                data-endpoint="POSTapi-posts--post_id--chat"
               value="16"
               data-component="body">
    <br>
<p>Must match an existing stored value. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-GETapi-conversations">GET api/conversations</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-conversations--conversation_id-">GET api/conversations/{conversation_id}</h2>
...
<span id="example-requests-GETapi-conversations--conversation_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/conversations/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-conversations--conversation_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-conversations--conversation_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-conversations--conversation_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-conversations--conversation_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-conversations--conversation_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-conversations--conversation_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-conversations--conversation_id-" data-method="GET"
      data-path="api/conversations/{conversation_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-conversations--conversation_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-conversations--conversation_id-"
                    onclick="tryItOut('GETapi-conversations--conversation_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-conversations--conversation_id-"
                    onclick="cancelTryOut('GETapi-conversations--conversation_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-conversations--conversation_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/conversations/{conversation_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="conversation_id"                data-endpoint="GETapi-conversations--conversation_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the conversation. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-conversations--conversation_id-">PATCH api/conversations/{conversation_id}</h2>
...
<span id="example-requests-PATCHapi-conversations--conversation_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-conversations--conversation_id-">
</span>
<span id="execution-results-PATCHapi-conversations--conversation_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-conversations--conversation_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-conversations--conversation_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-conversations--conversation_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-conversations--conversation_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-conversations--conversation_id-" data-method="PATCH"
      data-path="api/conversations/{conversation_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-conversations--conversation_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-conversations--conversation_id-"
                    onclick="tryItOut('PATCHapi-conversations--conversation_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-conversations--conversation_id-"
                    onclick="cancelTryOut('PATCHapi-conversations--conversation_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-conversations--conversation_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="conversation_id"                data-endpoint="PATCHapi-conversations--conversation_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the conversation. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PATCHapi-conversations--conversation_id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-conversations--conversation_id-">DELETE api/conversations/{conversation_id}</h2>
...
<span id="example-requests-DELETEapi-conversations--conversation_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-conversations--conversation_id-">
</span>
<span id="execution-results-DELETEapi-conversations--conversation_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-conversations--conversation_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-conversations--conversation_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-conversations--conversation_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-conversations--conversation_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-conversations--conversation_id-" data-method="DELETE"
      data-path="api/conversations/{conversation_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-conversations--conversation_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-conversations--conversation_id-"
                    onclick="tryItOut('DELETEapi-conversations--conversation_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-conversations--conversation_id-"
                    onclick="cancelTryOut('DELETEapi-conversations--conversation_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-conversations--conversation_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-conversations--conversation_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="conversation_id"                data-endpoint="DELETEapi-conversations--conversation_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the conversation. Example: <code>1</code></p>
